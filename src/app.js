...
function plotviz3() {
  ...
  d3.csv(window.location.host.includes('localhost') ? './data/sunburst_FINAL.csv' : 'https://alecmacmillen.github.io/capp30239-dynamic-portfolio/data/sunburst_FINAL.csv')
    .then(function (data) {
